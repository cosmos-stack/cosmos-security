    ...
    public class JenkinsLookup2Function : StreamableHashFunctionBase
    {
        ...
        private class BlockTransformer : BlockTransformerBase<BlockTransformer>
        {
            ...
            protected override IHashValue FinalizeHashValueInternal(CancellationToken cancellationToken)
            {
                ...
                {
                    case 11:
                        finalC += (UInt32) remainder[10] << 24;
                        goto case 10;
                    case 10:
                        finalC += (UInt32) remainder[9] << 16;
                        goto case 9;
                    case 9:
                        finalC += (UInt32) remainder[8] << 8;
                        goto case 8;
                    ...
                    case 7:
                        finalB += (UInt32) remainder[6] << 16;
                        goto case 6;
                    case 6:
                        finalB += (UInt32) remainder[5] << 8;
                        goto case 5;
                    case 5:
                        finalB += (UInt32) remainder[4];
                        goto case 4;
                    ...
                    case 3:
                        finalA += (UInt32) remainder[2] << 16;
                        goto case 2;
                    case 2:
                        finalA += (UInt32) remainder[1] << 8;
                        goto case 1;
                    case 1:
