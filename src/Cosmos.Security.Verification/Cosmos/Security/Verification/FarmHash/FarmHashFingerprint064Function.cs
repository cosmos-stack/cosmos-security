...
{
    internal class FarmHashFingerprint064Function : HashFunctionBase, IFarmHash
    {
        ...
        public override int HashSizeInBits => 64;
        ...
        protected override IHashValue ComputeHashInternal(ArraySegment<byte> data, CancellationToken cancellationToken)
        {
            ...
            {
                > 64 => ComputeHash65Plus(data, cancellationToken),
                > 32 => ComputeHash33To64(data),
                > 16 => ComputeHash17To32(data),
                _ => ComputeHash0To16(data)
            };
