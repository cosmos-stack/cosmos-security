...
{
    internal class xxHashFunction : StreamableHashFunctionBase, IxxXHash
    {
        private readonly xxHashConfig _config;

        private static readonly IEnumerable<int> _validHashSizes = new HashSet<int>() {32, 64};

        public xxHashFunction(xxHashConfig config)
        {
            if (config is null)
        ...
        public xxHashConfig Config => _config.Clone();
        ...
        public override IBlockTransformer CreateBlockTransformer()
        {
            ...
            {
                32 => new BlockTransformer32((UInt32) _config.Seed),
                64 => new BlockTransformer64(_config.Seed),
        ...
        private class BlockTransformer32 : BlockTransformerBase<BlockTransformer32>
        {
            ...
            public BlockTransformer32() : base(inputBlockSize: 16) { }
        ...
        private class BlockTransformer64 : BlockTransformerBase<BlockTransformer64>
        {
            ...
            public BlockTransformer64() : base(inputBlockSize: 32) { }

            public BlockTransformer64(UInt64 seed) : this()
            {
                _seed = seed;
