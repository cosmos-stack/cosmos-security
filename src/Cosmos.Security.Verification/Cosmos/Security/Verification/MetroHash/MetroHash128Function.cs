...
namespace Cosmos.Security.Verification
{
    public class MetroHash128Function : StreamableHashFunctionBase
    {
        ...
        public MetroHash128Function(MetroHashConfig config)
        {
            if (config is null)
        ...
        public MetroHashConfig Config => _config.Clone();

        public override int HashSizeInBits => 128;

        public override IBlockTransformer CreateBlockTransformer() => new BlockTransformer(_config.Seed);
