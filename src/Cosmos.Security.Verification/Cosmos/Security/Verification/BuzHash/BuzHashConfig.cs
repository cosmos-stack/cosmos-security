...
namespace Cosmos.Security.Verification
{
    ...
    {
        private static readonly IReadOnlyList<ulong> _Rtab = new ulong[]
        {
        ...
        public IReadOnlyList<ulong> Rtab { get; set; }

        public int HashSizeInBits { get; internal set; } = 64;
        ...
        public BuzHashConfig Clone() => new()
        {
            Rtab = Rtab?.ToArray(),
        ...
        /// <summary>
        /// Getting default BuzHash config
        /// </summary>
        public static BuzHashConfig Default { get; } = new()
        {
            Rtab = _Rtab,
            HashSizeInBits = 64,
            Seed = 0x3CD05367FD0337D3UL,
