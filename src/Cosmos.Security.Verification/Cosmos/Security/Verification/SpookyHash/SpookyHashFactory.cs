...
namespace Cosmos.Security.Verification
{
    ...
    {
        public static ISpookyHash Create(SpookyHashTypes type = SpookyHashTypes.SpookyHash2Bit128)
        {
            return Create(type, new SpookyHashConfig());
        }

        public static ISpookyHash Create(SpookyHashTypes type, SpookyHashConfig config)
        {
