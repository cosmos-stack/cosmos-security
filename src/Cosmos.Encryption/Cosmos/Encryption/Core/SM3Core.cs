...
namespace Cosmos.Encryption.Core
{
    internal class SM3Core : HashAlgorithm
    {
        ...
        {
            if (string.Equals(hashName, "SM3", StringComparison.OrdinalIgnoreCase) || string.Equals(hashName, "System.Security.Cryptography.SM3", StringComparison.OrdinalIgnoreCase))
            {
                return new SM3Core();
            }
            return null;
