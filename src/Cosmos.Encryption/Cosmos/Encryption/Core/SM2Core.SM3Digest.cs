...
namespace Cosmos.Encryption.Core {
    ...
    internal abstract class SM2_GeneralDigest : IDigest {
        ...
        internal SM2_GeneralDigest() {
            xBuf = new byte[4];
        }

        internal SM2_GeneralDigest(SM2_GeneralDigest t) {
    ...
    // ReSharper disable once InconsistentNaming
    internal class SM2_SM3Digest : SM2_GeneralDigest {
        ...
        private static readonly int[] v0 = new int[]
            {0x7380166f, 0x4914b2b9, 0x172442d7, unchecked((int) 0xda8a0600), unchecked((int) 0xa96f30bc), 0x163138aa, unchecked((int) 0xe38dee4d), unchecked((int) 0xb0fb0e4e)};
        ...
        public SM2_SM3Digest() {
            Reset();
        }

        public SM2_SM3Digest(SM2_SM3Digest t)
            : base(t) {
        ...
        internal override void ProcessLength(long bitLength) {
            ...
            X[14] = (int) (SM2_SM3CommonHelper.URShift(bitLength, 32));
            X[15] = (int) (bitLength & unchecked((int) 0xffffffff));
        }

        public static void IntToBigEndian(int n, byte[] bs, int off) {
            bs[off] = (byte) (SM2_SM3CommonHelper.URShift(n, 24));
            bs[++off] = (byte) (SM2_SM3CommonHelper.URShift(n, 16));
            bs[++off] = (byte) (SM2_SM3CommonHelper.URShift(n, 8));
            bs[++off] = (byte) (n);
        }
        ...
        private int ROTATE(int x, int n) {
            return (x << n) | (SM2_SM3CommonHelper.URShift(x, (32 - n)));
        }
    ...
    // ReSharper disable once InconsistentNaming
    internal static class SM2_SM3CommonHelper {
        /// <summary>
