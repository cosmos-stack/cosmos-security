...
#if NETCOREAPP3_1 || NETSTANDARD2_1                
                RSAKeyTypes.Pkcs1 => BaseConv.ToBase64(rsa.ExportRSAPrivateKey()),
                RSAKeyTypes.Pkcs8 => BaseConv.ToBase64(rsa.ExportPkcs8PrivateKey()),
#else
...
#if NETCOREAPP3_1 || NETSTANDARD2_1
                RSAKeyTypes.Pkcs1 => BaseConv.ToBase64(rsa.ExportRSAPublicKey()),
                RSAKeyTypes.Pkcs8 => BaseConv.ToBase64(rsa.ExportRSAPublicKey()),
#else
